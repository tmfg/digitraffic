...
# Java WebClient
__Q__: How do I call the APIs with [Java WebClient](https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/web/reactive/function/client/WebClient.html)?
__A__:
```java
